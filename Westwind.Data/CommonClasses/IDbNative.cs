...
namespace Westwind.Data
{
    ...
    public interface IDbNative
    {
        ...
        /// <param name="dbParameters">Supports either DbParameter instances or positional parameters with @0,@1,@2 etc. and values passed</param>
        /// <returns></returns>
        DbCommand CreateCommand(string sql, params object[] dbParameters);
        ...
        DbDataReader ExecuteReader(DbCommand sqlCommand, params object[] dbParameters);
        /// <summary>
        /// Returns a DbDataReader from a SQL statement.
        /// 
        /// Note:
        ...
        /// <param name="dbParameters"></param>
        /// <returns></returns>
        DbDataReader ExecuteReader(string sql, params object[] dbParameters);
        /// <summary>
        ...
        /// <param name="dbParameters"></param>
        /// <returns></returns>
        DataTable ExecuteDataTable(DbCommand sqlCommand, string tableName, params object[] dbParameters);
        /// <summary>
        ...
        /// <param name="tableName"></param>
        /// <param name="dbParameters"></param>
        DataTable ExecuteDataTable(string sql, string tableName, params object[] dbParameters);
        /// <summary>
        ...
        /// <returns></returns>
        DataSet ExecuteDataSet(DbCommand sqlCommand, DataSet dataSet, string tableName, params object[] dbParameters);
        /// <summary>
        /// Runs a query and returns a table in a DataSet either passed in or
        /// by creating a new one.
        /// </summary>
        ...
        /// <param name="dbParameters">Optional SQL statement parameters</param>
        /// <returns></returns>
        DataSet ExecuteDataSet(string sql, DataSet dataSet, string tableName, params object[] dbParameters);
        /// <summary>
        /// Runs a query and returns a table in a DataSet either passed in or
        /// by creating a new one.
        /// </summary>
        ...
        int ExecuteNonQuery(DbCommand sqlCommand, params object[] dbParameters);
        /// <summary>
        /// Executes a raw Sql Command against the server that doesn't return
        /// a result set.
        /// </summary>
        ...
        /// <param name="dbParameters"></param>
        /// <returns>-1 on error. Records affected otherwise</returns>
        int ExecuteNonQuery(string sql, params object[] dbParameters);
        /// <summary>
        ...
        /// <param name="dbParameters"></param>
        /// <returns></returns>
        object ExecuteScalar(DbCommand command, params object[] dbParameters);
        /// <summary>
        ...
        /// <param name="dbParameters"></param>
        /// <returns></returns>
        object ExecuteScalar(string sql, params object[] dbParameters);
    }
}
