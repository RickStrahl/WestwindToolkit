...
{
    public interface IBusinessBase<TEntity, TContext> where TEntity : class, new() where TContext : DbContext, new()
    {
        /// <summary>
...
/// to load the properties to and from a text field.
        ...
        TransactionScope CreateTransactionScope(IsolationLevel isolationLevel = IsolationLevel.Unspecified);
